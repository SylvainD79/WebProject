...
public class Highscoreentityendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "insertOrUpdateHighScoreEntity".
   *
   * This request holds the parameters needed by the highscoreentityendpoint server.  After setting
   * any optional parameters, call the {@link InsertOrUpdateHighScoreEntity#execute()} method to
   * invoke the remote operation.
   *
   * @param content the {@link com.mycompany.services.highscoreentityendpoint.model.HighScoreEntity}
   * @return the request
   */
  public InsertOrUpdateHighScoreEntity insertOrUpdateHighScoreEntity(com.mycompany.services.highscoreentityendpoint.model.HighScoreEntity content) throws java.io.IOException {
    InsertOrUpdateHighScoreEntity result = new InsertOrUpdateHighScoreEntity(content);
    initialize(result);
    return result;
  }

  public class InsertOrUpdateHighScoreEntity extends HighscoreentityendpointRequest<Void> {
     ...
     *
     * This request holds the parameters needed by the the highscoreentityendpoint server.  After
     * setting any optional parameters, call the {@link InsertOrUpdateHighScoreEntity#execute()}
     * method to invoke the remote operation. <p> {@link InsertOrUpdateHighScoreEntity#initialize(com.
     ...
     * @since 1.13
     */
    protected InsertOrUpdateHighScoreEntity(com.mycompany.services.highscoreentityendpoint.model.HighScoreEntity content) {
      super(Highscoreentityendpoint.this, "POST", REST_PATH, content, Void.class);
    }

    @Override
    public InsertOrUpdateHighScoreEntity setAlt(java.lang.String alt) {
      return (InsertOrUpdateHighScoreEntity) super.setAlt(alt);
    }

    @Override
    public InsertOrUpdateHighScoreEntity setFields(java.lang.String fields) {
      return (InsertOrUpdateHighScoreEntity) super.setFields(fields);
    }

    @Override
    public InsertOrUpdateHighScoreEntity setKey(java.lang.String key) {
      return (InsertOrUpdateHighScoreEntity) super.setKey(key);
    }

    @Override
    public InsertOrUpdateHighScoreEntity setOauthToken(java.lang.String oauthToken) {
      return (InsertOrUpdateHighScoreEntity) super.setOauthToken(oauthToken);
    }

    @Override
    public InsertOrUpdateHighScoreEntity setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (InsertOrUpdateHighScoreEntity) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public InsertOrUpdateHighScoreEntity setQuotaUser(java.lang.String quotaUser) {
      return (InsertOrUpdateHighScoreEntity) super.setQuotaUser(quotaUser);
    }

    @Override
    public InsertOrUpdateHighScoreEntity setUserIp(java.lang.String userIp) {
      return (InsertOrUpdateHighScoreEntity) super.setUserIp(userIp);
    }

    @Override
    public InsertOrUpdateHighScoreEntity set(String parameterName, Object value) {
      return (InsertOrUpdateHighScoreEntity) super.set(parameterName, value);
    }
  }
