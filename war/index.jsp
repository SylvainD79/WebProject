	            ...
	            <div class="row">
	                <div class="col-lg-3 col-md-6 text-center">
	                    <div class="service-box">
	                        ...
	                        <tag:loggedin>
	                        	<br>
		                        <a href="#sport" class="btn btn-primary btn-xl page-scroll">
				                	<i class="fa fa-chevron-down"></i>&nbsp;Get Started
								</a>
							</tag:loggedin>
	                    </div>
	                ...
	                <div class="col-lg-3 col-md-6 text-center">
	                    <div class="service-box">
	                        ...
	                        <tag:loggedin>
	                        	<br>
	                        	<a href="#tv" class="btn btn-primary btn-xl page-scroll">
			                		<i class="fa fa-chevron-down"></i>&nbsp;Get Started
								</a>
							</tag:loggedin>
	                    </div>
	                ...
	                <div class="col-lg-3 col-md-6 text-center">
	                    <div class="service-box">
	                        ...
	                        <tag:loggedin>
	                        	<br>
	                        	<a href="#policy" class="btn btn-primary btn-xl page-scroll">
			                		<i class="fa fa-chevron-down"></i>&nbsp;Get Started
								</a>
							</tag:loggedin>
	                    </div>
	                ...
	                <div class="col-lg-3 col-md-6 text-center">
	                    <div class="service-box">
	                        ...
	                        <tag:loggedin>
	                        	<br>
	                        	<a href="#game" class="btn btn-primary btn-xl page-scroll">
			                		<i class="fa fa-chevron-down"></i>&nbsp;Get Started
								</a>
							</tag:loggedin>
	                    </div>
